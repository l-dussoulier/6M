                ...
                <div class="bg-white shadow-md rounded my-6">
                    <form action="{{ route('store-promotion-request') }}" method="post" class="form-group ml-10 mr-10 pt-5 pb-16" enctype="multipart/form-data">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <textarea name="description" id="description" rows="3" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md mb-6"></textarea>
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                            <label for="code" class="block text-sm font-medium text-gray-700 mt-2">Code</label>
                            <input type="text" name="code" id="code" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md mb-6">
                        </div>
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="number" name="NbUtilisation" id="NbUtilisation" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md mb-6">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="datetime-local" name="validite" id="validite" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md mb-2">
                            </div>
                        </div>
