                    ...
                    <form action="{{ route('store-article-request') }}" method="post" class="form-group ml-10 mr-10 pt-5 pb-16" enctype="multipart/form-data">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <div>
                                ...
                                <input type="number" value="{{$s->stock}}" name="s" id="s" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-1/6 shadow-sm sm:text-sm border-gray-300 rounded-md mb-6">

                                <label for="m" class="block text-sm font-medium text-gray-700 mt-2">M</label>
                                <input type="number" value="{{$m->stock}}" name="m" id="m" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-1/6 shadow-sm sm:text-sm border-gray-300 rounded-md mb-6">

                                <label for="l" class="block text-sm font-medium text-gray-700 mt-2">L</label>
                                <input type="number" value="{{$l->stock}}" name="l" id="l" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-1/6 shadow-sm sm:text-sm border-gray-300 rounded-md mb-6">

                                <label for="xl" class="block text-sm font-medium text-gray-700 mt-2">XL</label>
                                <input type="number" value="{{$xl->stock}}" name="xl" id="xl" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-1/6 shadow-sm sm:text-sm border-gray-300 rounded-md mb-6">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="number" step="0.01" value="{{ $currentArticle->prix }}" name="prix" id="prix" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md mb-2">
                            </div>
                        </div>
                            ...
                            <div class="mt-1">
                                <select name="drop" id="drop" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md mb-2">
                                    @foreach($listeDrop as $drop)
                                        <option value="{{ $drop->id }}" @if($currentArticle->id_drop == $drop->id) selected="selected" @endif>{{ $drop->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
